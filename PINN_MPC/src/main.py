...
if __name__ == "__main__":
    ...
    # Paths
    resources_path = os.path.join('/home/vaidehi/Downloads/github/PINNs-based-MPC/resources')
    data_path = os.path.join(resources_path, 'data.npz')
    weights_path = os.path.join('/home/vaidehi/Downloads/github/PINNs-based-MPC/resources/weights')

    lb, ub, input_dim, output_dim, X_test, Y_test, _, _ = load_data(data_path)
    ...
    plot_states(T_sl, X_ref_sl, Z_pred=X_sl, Z_ref2=X_ref)
    # plot_states(T_sl, X_ref, X_sl)
    ...
    # plot_states(T_ref, X_ref, X_ref, Z_ref2=X_ref, Z_mpc=X_mpc)
    plot_absolute_error(T_ref, Z_mpc=X_mpc)
